            ...
            <div class="day-editor-grid">
              ...
              <div class="editor-column"
                ...
                ${n?(()=>{const t=this._currentDragOverlaps();return L`
                  ...
                  `})():""}
                ${p?L`<div class="now-line" style="top: ${u}%;"><span class="now-line-label">${this._minutesToTimeStr(60*l.getHours()+l.getMinutes()).slice(0,5)}</span></div>`:""}
                ${0!==g.length||n?"":L`
