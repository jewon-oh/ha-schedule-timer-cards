          ...
          <div class="day-editor">
            <div class="day-editor-grid">
              ...
              <div class="editor-column"
                ...
                `)}
                ${g.map((t,e)=>{const i=this._timeToMinutes(t.from),s=this._timeToMinutes(t.to),r=i/a*100,o=(s-i)/a*100,n=this._selectedBlockIdx===e,c=r<7;return L`
                    <button type="button"
                  ...
                  `})}
                ${n?(()=>{const t=this._currentDragOverlaps();return L`
                    <div class="editor-block pending dragging ${t?"conflict":""}"
                         style="top: ${c/a*100}%; height: ${Math.max((l-c)/a*100,.5)}%;">
                      <span class="block-time-label">
                        ${t?"⚠ ":""}${this._minutesToTimeStr(c).slice(0,5)} ~ ${this._minutesToTimeStr(l).slice(0,5)}
                      </span>
                    </div>
                  `})():""}
                ${p?L`<div class="now-line" style="top: ${u}%;"><span class="now-line-label">${this._minutesToTimeStr(60*d.getHours()+d.getMinutes()).slice(0,5)}</span></div>`:""}
                ${0!==g.length||n?"":L`
