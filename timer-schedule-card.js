          ...
          <div class="day-editor">
            <div class="day-editor-grid">
              ...
              <div class="editor-column"
                ...
                `)}
                ${m.map((t,e)=>{const i=this._timeToMinutes(t.from),s=this._timeToMinutes(t.to),r=i/n*100,o=(s-i)/n*100,a=this._selectedBlockIdx===e;return q`
                    <button type="button"
                ...
                ${a?(()=>{const t=this._currentDragOverlaps();return q`
                  ...
                  `})():""}
                ${p?q`<div class="now-line" style="top: ${u}%;"><span class="now-line-label">${this._minutesToTimeStr(60*d.getHours()+d.getMinutes()).slice(0,5)}</span></div>`:""}
                ${0!==m.length||a?"":q`
