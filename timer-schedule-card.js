const t={ko:{addBlock:"새 블록 추가",startTime:"시작 시간",endTime:"종료 시간",add:"시간 블록 추가하기",delete:"삭제",cancel:"취소",save:"저장",repeat:"반복",days:["월","화","수","목","금","토","일"],daysShort:["월","화","수","목","금","토","일"],everyday:"매일",empty:"설정된 스케쥴이 없습니다.",errorEntity:"스케쥴 엔티티를 설정해야 합니다.",scheduleManager:"스케쥴 관리",placeholder:"스마트 스케쥴 카드",previewSuffix:" (미리보기)",conflictWarning:"이 요일은 기존 블록과 겹칩니다",createRoutine:"새 스케쥴 만들기",routineName:"스케쥴 이름",routineNamePlaceholder:"예: 거실 전등 스케쥴",targetDevice:"대상 기기",create:"스케쥴 생성",creating:"생성 중...",createSuccess:"스케쥴이 생성되었습니다!",createFailed:"스케쥴 생성에 실패했습니다.",createDescription:"기기를 선택하면 스케쥴과 자동화가 자동으로 생성됩니다.",orSelectExisting:"또는 기존 스케쥴을 편집기에서 선택하세요.",goToCard:"카드 편집에서 새 스케쥴을 선택해주세요.",editorWizardTitle:"새 스케쥴 만들기 (권장)",editorWizardDesc:"자동화할 기기를 선택하면 스케쥴 제어 장치와 동작 브릿지가 즉시 생성되고 이 카드에 자동으로 연동됩니다.",editorTargetDevice:"제어할 대상 기기 선택",editorCreateSuccess:"생성 및 연결 성공!",editorErrorPrefix:"오류 발생: ",editorAdvanced:"기존 스케쥴 다시 불러오기 및 추가 설정",editorScheduleEntity:"스케쥴 기기 (직접 선택)",editorCardTitle:"카드 표출 제목 (선택사항)",cardName:"스케쥴 카드",cardDescription:"스케쥴 헬퍼의 시간 블록을 편집하고, 기기를 선택하면 스케쥴을 자동 생성합니다.",deleteEverydayConfirm:"이 타임블록은 매일(월~일) 등록되어 있습니다.\n삭제하시면 모든 요일에서 일괄 삭제됩니다. 계속하시겠습니까?",deleteOneConfirm:"선택하신 요일의 스케줄을 삭제하시겠습니까?",conflictAlert:"다음 요일에 이미 겹치는 블록이 있어 저장할 수 없습니다: ",unknownDevice:"알 수 없는 기기",routineSuffix:" 스케쥴",bridgeAliasPrefix:"스케쥴 브릿지: ",bridgeDescPattern:" 스케쥴에 따라 기기를 자동 제어합니다.",activeDays:"활성 요일",activeDaysHelp:"선택한 요일들이 동일한 시간 블록 세트를 공유합니다.",atLeastOneDay:"최소 한 요일은 활성화되어 있어야 합니다.",confirmDeleteBlock:"이 시간 블록을 삭제하시겠습니까?",confirmDeleteTitle:"시간 블록 삭제",saveFailed:"저장에 실패했습니다.",blockOverlap:"다른 시간 블록과 겹쳐 추가할 수 없습니다.",notConfigured:"카드가 구성되지 않았습니다.",adminOnlyWizard:"스케쥴 자동 생성은 관리자만 가능합니다. 이미 만들어진 스케쥴을 아래에서 선택하세요.",unauthorized:"권한이 없습니다. 관리자에게 문의하세요."},en:{addBlock:"Add New Block",startTime:"Start Time",endTime:"End Time",add:"Add Time Block",delete:"Delete",cancel:"Cancel",save:"Save",repeat:"Repeat",days:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],daysShort:["M","T","W","T","F","S","S"],everyday:"Daily",empty:"No schedules configured.",errorEntity:"You need to define a schedule entity.",scheduleManager:"Schedule Manager",placeholder:"Smart Schedule Card",previewSuffix:" (Preview)",conflictWarning:"This day conflicts with an existing block",createRoutine:"Create New Routine",routineName:"Routine Name",routineNamePlaceholder:"e.g. Living Room Light",targetDevice:"Target Device",create:"Create Routine",creating:"Creating...",createSuccess:"Routine created successfully!",createFailed:"Failed to create routine.",createDescription:"Select a device to auto-create a schedule and automation.",orSelectExisting:"Or select an existing schedule in the editor.",goToCard:"Please select the new schedule in card settings.",editorWizardTitle:"Create New Routine (Recommended)",editorWizardDesc:"Pick a device to auto-create a schedule helper and automation bridge linked to this card.",editorTargetDevice:"Target Device",editorCreateSuccess:"Created and linked successfully!",editorErrorPrefix:"Error: ",editorAdvanced:"Advanced Configuration",editorScheduleEntity:"Schedule Entity",editorCardTitle:"Card Title (Optional)",cardName:"Schedule Card",cardDescription:"Edit schedule helper time blocks, or pick a device to auto-create one.",deleteEverydayConfirm:"This block is registered for every day (Mon–Sun).\nDeleting will remove it from all days. Continue?",deleteOneConfirm:"Delete this block from the selected day?",conflictAlert:"Cannot save — the following day(s) already have overlapping blocks: ",unknownDevice:"Unknown device",routineSuffix:" Schedule",bridgeAliasPrefix:"Schedule bridge: ",bridgeDescPattern:" — automatically controls the target device per its schedule.",activeDays:"Active days",activeDaysHelp:"Selected days share the same set of time blocks.",atLeastOneDay:"At least one day must stay active.",confirmDeleteBlock:"Delete this time block?",confirmDeleteTitle:"Delete time block",saveFailed:"Failed to save schedule.",blockOverlap:"This range overlaps an existing block.",notConfigured:"Card is not configured.",adminOnlyWizard:"Auto-creating a schedule requires admin rights. Pick an existing schedule below.",unauthorized:"Not authorized. Ask an administrator."}},e={ko:{addTitle:"+ 시간 추가",start:"시작",pause:"일시정지",resume:"계속",stop:"취소",preset5m:"+5분",preset10m:"+10분",preset30m:"+30분",presetMinus5m:"-5분",presetMinus10m:"-10분",presetMinus30m:"-30분",setDuration:"시간 설정",idleMessage:"대기 중",pausedMessage:"일시정지됨",editorTitle:"타이머 UI 설정",editorEntity:"연동된 타이머 엔티티",editorWizardTitle:"새 타이머 & 자동화 마법사",editorWizardDesc:"기기를 선택하면 타이머 헬퍼와 자동화 브릿지가 즉시 생성됩니다.",editorTargetDevice:"대상 기기 선택 (켜고 끌 기기)",editorActionType:"종료 시 동작",editorActionOff:"장치 끄기",editorActionOn:"장치 켜기",editorActionToggle:"상태 반전",editorCreateStr:"타이머 자동 생성",hoursLabel:"시간",minutesLabel:"분",secondsLabel:"초",hoursStr:"시간",minutesStr:"분",secondsStr:"초",countdownMessage:"후에 기기가 종료됩니다.",bridgeDescription:"Timer UI 카드에서 자동으로 생성한 브릿지입니다.",errorPrefix:"생성 중 오류가 발생했습니다: ",timerSuffix:" 타이머",cardName:"타이머 카드",cardDescription:"타이머 헬퍼를 제어하고, 기기를 선택하면 자동화 브릿지를 자동 생성합니다.",defaultTitle:"타이머 설정",helperFailMsg:"(안내) 타이머 헬퍼 생성 실패. 해당 HA 버전에서는 플러그인이 헬퍼를 완전 자동 생성할 수 없습니다. 수동 구성 권장.",timerBridgeAliasPrefix:"타이머 브릿지: ",syncingMessage:"동기화 중입니다...",generatedTimerLabel:" (생성된 타이머)",notConfigured:"카드가 구성되지 않았습니다.",adminOnlyWizard:"타이머 자동 생성은 관리자만 가능합니다. 이미 만들어진 타이머를 아래에서 선택하세요.",unauthorized:"권한이 없습니다. 관리자에게 문의하세요."},en:{addTitle:"+ Add Time",start:"Start",pause:"Pause",resume:"Resume",stop:"Cancel",preset5m:"+5m",preset10m:"+10m",preset30m:"+30m",presetMinus5m:"-5m",presetMinus10m:"-10m",presetMinus30m:"-30m",setDuration:"Set Duration",idleMessage:"Idle",pausedMessage:"Paused",editorTitle:"Timer UI Config",editorEntity:"Linked Timer Entity",editorWizardTitle:"New Timer Wizard",editorWizardDesc:"Select a target device to auto-create timer and automation.",editorTargetDevice:"Select Target Device",editorActionType:"Action on finish",editorActionOff:"Turn Off",editorActionOn:"Turn On",editorActionToggle:"Toggle",editorCreateStr:"Auto Create Timer",hoursLabel:"Hours",minutesLabel:"Minutes",secondsLabel:"Seconds",hoursStr:"h",minutesStr:"m",secondsStr:"s",countdownMessage:"until the device turns off.",bridgeDescription:"Bridge automatically created by Timer UI card.",errorPrefix:"Error while creating: ",timerSuffix:" Timer",cardName:"Timer Card",cardDescription:"Control timer helpers, or pick a device to auto-create an automation bridge.",defaultTitle:"Timer Settings",helperFailMsg:"(Notice) Timer helper auto-create failed. This HA version does not allow plugins to create helpers automatically — please configure manually.",timerBridgeAliasPrefix:"Timer bridge: ",syncingMessage:"Syncing...",generatedTimerLabel:" (generated)",notConfigured:"Card is not configured.",adminOnlyWizard:"Auto-creating a timer requires admin rights. Pick an existing timer below.",unauthorized:"Not authorized. Ask an administrator."}},i={ko:{cardName:"켜기 스케쥴 카드",cardDescription:"지정한 시각마다 기기를 켭니다 (요일 지정 가능, 끄기는 수동).",placeholder:"켜기 스케쥴 카드",previewSuffix:" (미리보기)",title:"켜기 스케쥴",notConfigured:"카드가 구성되지 않았습니다.",automationNotFound:"연결된 자동화를 찾을 수 없습니다. 카드 설정에서 자동화를 선택하세요.",times:"켜기 시각",addTime:"시각 추가",noTimes:"등록된 시각이 없습니다. + 버튼으로 추가하세요.",days:["월","화","수","목","금","토","일"],daysShort:["월","화","수","목","금","토","일"],daysHelp:"선택한 요일에 위 시각마다 기기를 켭니다.",atLeastOneDay:"최소 한 요일은 활성화되어 있어야 합니다.",duplicateTime:"이미 등록된 시각입니다.",target:"대상 기기",saveFailed:"저장에 실패했습니다.",unauthorized:"권한이 없습니다. 관리자에게 문의하세요.",delete:"삭제",cancel:"취소",confirmDeleteTitle:"시각 삭제",confirmDeleteTime:"이 시각을 삭제하시겠습니까?",editorWizardTitle:"켜기 스케쥴 만들기 (권장)",editorWizardDesc:"기기를 선택하면 켜기 전용 자동화가 즉시 생성되고 이 카드에 연결됩니다.",editorTargetDevice:"켤 대상 기기 선택",editorAdvanced:"기존 자동화 다시 불러오기",editorAutomationEntity:"자동화 (직접 선택)",editorCardTitle:"카드 표출 제목 (선택사항)",editorCreateSuccess:"생성 및 연결 성공!",editorErrorPrefix:"오류 발생: ",creating:"생성 중...",adminOnlyWizard:"켜기 스케쥴 자동 생성은 관리자만 가능합니다.",unknownDevice:"알 수 없는 기기",routineSuffix:" 켜기 스케쥴",automationDescTag:"[schedule-ui:turn-on]"},en:{cardName:"Turn-On Schedule Card",cardDescription:"Turns a device on at the listed times (per weekday). Off is manual.",placeholder:"Turn-On Schedule Card",previewSuffix:" (Preview)",title:"Turn-On Schedule",notConfigured:"Card is not configured.",automationNotFound:"Linked automation not found. Pick one in the card editor.",times:"Trigger times",addTime:"Add time",noTimes:"No times yet. Use + to add one.",days:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],daysShort:["M","T","W","T","F","S","S"],daysHelp:"On the selected weekdays, the device is turned on at each time above.",atLeastOneDay:"At least one day must stay active.",duplicateTime:"That time is already in the list.",target:"Target device",saveFailed:"Failed to save.",unauthorized:"Not authorized. Ask an administrator.",delete:"Delete",cancel:"Cancel",confirmDeleteTitle:"Delete time",confirmDeleteTime:"Delete this time?",editorWizardTitle:"Create Turn-On Schedule (Recommended)",editorWizardDesc:"Pick a device to auto-create a turn-on automation linked to this card.",editorTargetDevice:"Target device to turn on",editorAdvanced:"Advanced Configuration",editorAutomationEntity:"Automation entity",editorCardTitle:"Card Title (Optional)",editorCreateSuccess:"Created and linked successfully!",editorErrorPrefix:"Error: ",creating:"Creating...",adminOnlyWizard:"Auto-creating a turn-on schedule requires admin rights.",unknownDevice:"Unknown device",routineSuffix:" Turn-On Schedule",automationDescTag:"[schedule-ui:turn-on]"}};function s(){return("undefined"!=typeof navigator&&navigator.language||"en").startsWith("ko")?"ko":"en"}const o=globalThis,a=o.ShadowRoot&&(void 0===o.ShadyCSS||o.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,r=Symbol(),n=new WeakMap;let c=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==r)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(a&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=n.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&n.set(e,t))}return t}toString(){return this.cssText}};const d=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new c(i,t,r)},l=a?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new c("string"==typeof t?t:t+"",void 0,r))(e)})(t):t,{is:h,defineProperty:u,getOwnPropertyDescriptor:p,getOwnPropertyNames:m,getOwnPropertySymbols:g,getPrototypeOf:f}=Object,_=globalThis,b=_.trustedTypes,v=b?b.emptyScript:"",y=_.reactiveElementPolyfillSupport,x=(t,e)=>t,$={toAttribute(t,e){switch(e){case Boolean:t=t?v:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},w=(t,e)=>!h(t,e),k={attribute:!0,type:String,converter:$,reflect:!1,useDefault:!1,hasChanged:w};Symbol.metadata??=Symbol("metadata"),_.litPropertyMetadata??=new WeakMap;let S=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=k){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&u(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:o}=p(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:s,set(e){const a=s?.call(this);o?.call(this,e),this.requestUpdate(t,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??k}static _$Ei(){if(this.hasOwnProperty(x("elementProperties")))return;const t=f(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(x("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(x("properties"))){const t=this.properties,e=[...m(t),...g(t)];for(const i of e)this.createProperty(i,t[i])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(l(t))}else void 0!==t&&e.push(l(t));return e}static _$Eu(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{if(a)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const i of e){const e=document.createElement("style"),s=o.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){const o=(void 0!==i.converter?.toAttribute?i.converter:$).toAttribute(e,i.type);this._$Em=t,null==o?this.removeAttribute(s):this.setAttribute(s,o),this._$Em=null}}_$AK(t,e){const i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){const t=i.getPropertyOptions(s),o="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:$;this._$Em=s;const a=o.fromAttribute(e,t.type);this[s]=a??this._$Ej?.get(s)??a,this._$Em=null}}requestUpdate(t,e,i,s=!1,o){if(void 0!==t){const a=this.constructor;if(!1===s&&(o=this[t]),i??=a.getPropertyOptions(t),!((i.hasChanged??w)(o,e)||i.useDefault&&i.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(a._$Eu(t,i))))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:o},a){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??e??this[t]),!0!==o||void 0!==a)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),!0===s&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,i]of t){const{wrapped:t}=i,s=this[e];!0!==t||this._$AL.has(e)||void 0===s||this.C(e,void 0,i,s)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[x("elementProperties")]=new Map,S[x("finalized")]=new Map,y?.({ReactiveElement:S}),(_.reactiveElementVersions??=[]).push("2.1.2");const T=globalThis,C=t=>t,A=T.trustedTypes,z=A?A.createPolicy("lit-html",{createHTML:t=>t}):void 0,D="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,M="?"+E,P=`<${M}>`,O=document,I=()=>O.createComment(""),N=t=>null===t||"object"!=typeof t&&"function"!=typeof t,U=Array.isArray,H="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,W=/-->/g,L=/>/g,B=RegExp(`>|${H}(?:([^\\s"'>=/]+)(${H}*=${H}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),j=/'/g,F=/"/g,q=/^(?:script|style|textarea|title)$/i,V=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),Y=Symbol.for("lit-noChange"),X=Symbol.for("lit-nothing"),K=new WeakMap,J=O.createTreeWalker(O,129);function G(t,e){if(!U(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==z?z.createHTML(e):e}const Z=(t,e)=>{const i=t.length-1,s=[];let o,a=2===e?"<svg>":3===e?"<math>":"",r=R;for(let e=0;e<i;e++){const i=t[e];let n,c,d=-1,l=0;for(;l<i.length&&(r.lastIndex=l,c=r.exec(i),null!==c);)l=r.lastIndex,r===R?"!--"===c[1]?r=W:void 0!==c[1]?r=L:void 0!==c[2]?(q.test(c[2])&&(o=RegExp("</"+c[2],"g")),r=B):void 0!==c[3]&&(r=B):r===B?">"===c[0]?(r=o??R,d=-1):void 0===c[1]?d=-2:(d=r.lastIndex-c[2].length,n=c[1],r=void 0===c[3]?B:'"'===c[3]?F:j):r===F||r===j?r=B:r===W||r===L?r=R:(r=B,o=void 0);const h=r===B&&t[e+1].startsWith("/>")?" ":"";a+=r===R?i+P:d>=0?(s.push(n),i.slice(0,d)+D+i.slice(d)+E+h):i+E+(-2===d?e:h)}return[G(t,a+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class Q{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,a=0;const r=t.length-1,n=this.parts,[c,d]=Z(t,e);if(this.el=Q.createElement(c,i),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=J.nextNode())&&n.length<r;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(D)){const e=d[a++],i=s.getAttribute(t).split(E),r=/([.?@])?(.*)/.exec(e);n.push({type:1,index:o,name:r[2],strings:i,ctor:"."===r[1]?ot:"?"===r[1]?at:"@"===r[1]?rt:st}),s.removeAttribute(t)}else t.startsWith(E)&&(n.push({type:6,index:o}),s.removeAttribute(t));if(q.test(s.tagName)){const t=s.textContent.split(E),e=t.length-1;if(e>0){s.textContent=A?A.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],I()),J.nextNode(),n.push({type:2,index:++o});s.append(t[e],I())}}}else if(8===s.nodeType)if(s.data===M)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(E,t+1));)n.push({type:7,index:o}),t+=E.length-1}o++}}static createElement(t,e){const i=O.createElement("template");return i.innerHTML=t,i}}function tt(t,e,i=t,s){if(e===Y)return e;let o=void 0!==s?i._$Co?.[s]:i._$Cl;const a=N(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=o:i._$Cl=o),void 0!==o&&(e=tt(t,o._$AS(t,e.values),o,s)),e}class et{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??O).importNode(e,!0);J.currentNode=s;let o=J.nextNode(),a=0,r=0,n=i[0];for(;void 0!==n;){if(a===n.index){let e;2===n.type?e=new it(o,o.nextSibling,this,t):1===n.type?e=new n.ctor(o,n.name,n.strings,this,t):6===n.type&&(e=new nt(o,this,t)),this._$AV.push(e),n=i[++r]}a!==n?.index&&(o=J.nextNode(),a++)}return J.currentNode=O,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class it{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=X,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=tt(this,t,e),N(t)?t===X||null==t||""===t?(this._$AH!==X&&this._$AR(),this._$AH=X):t!==this._$AH&&t!==Y&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>U(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==X&&N(this._$AH)?this._$AA.nextSibling.data=t:this.T(O.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=Q.createElement(G(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new et(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new Q(t)),e}k(t){U(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new it(this.O(I()),this.O(I()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=C(t).nextSibling;C(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,o){this.type=1,this._$AH=X,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=X}_$AI(t,e=this,i,s){const o=this.strings;let a=!1;if(void 0===o)t=tt(this,t,e,0),a=!N(t)||t!==this._$AH&&t!==Y,a&&(this._$AH=t);else{const s=t;let r,n;for(t=o[0],r=0;r<o.length-1;r++)n=tt(this,s[i+r],e,r),n===Y&&(n=this._$AH[r]),a||=!N(n)||n!==this._$AH[r],n===X?t=X:t!==X&&(t+=(n??"")+o[r+1]),this._$AH[r]=n}a&&!s&&this.j(t)}j(t){t===X?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class ot extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===X?void 0:t}}class at extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==X)}}class rt extends st{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){if((t=tt(this,t,e,0)??X)===Y)return;const i=this._$AH,s=t===X&&i!==X||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==X&&(i===X||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){tt(this,t)}}const ct=T.litHtmlPolyfillSupport;ct?.(Q,it),(T.litHtmlVersions??=[]).push("3.3.3");const dt=globalThis;class lt extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let o=s._$litPart$;if(void 0===o){const t=i?.renderBefore??null;s._$litPart$=o=new it(e.insertBefore(I(),t),t,void 0,i??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Y}}lt._$litElement$=!0,lt.finalized=!0,dt.litElementHydrateSupport?.({LitElement:lt});const ht=dt.litElementPolyfillSupport;ht?.({LitElement:lt}),(dt.litElementVersions??=[]).push("4.2.2");class ut extends lt{static{this.properties={hass:{},_config:{},_isCreating:{type:Boolean},_createResult:{type:Object}}}setConfig(t){this._config=t}configChanged(t){const e=new Event("config-changed",{bubbles:!0,composed:!0});e.detail={config:t},this.dispatchEvent(e)}async _onAutoCreateDevicePicker(t){const e=t.detail.value;if(this._isCreating||!this.hass||!e)return;const i=this.hass.states[e],s=`${i?.attributes?.friendly_name||e.split(".")[1]||this._t("unknownDevice")}${this._t("routineSuffix")}`;this._isCreating=!0,this._createResult=null,this.requestUpdate();try{console.log("[schedule-ui] Editor Auto createRoutine - name:",s,"target:",e);const t={type:"schedule/create",name:s,icon:"mdi:calendar-clock"},i=await this.hass.callWS(t);console.log("[schedule-ui] schedule/create SUCCESS:",i);const o=i.id,a=`schedule.${o}`,r=`bridge_${o}`,n={alias:`${this._t("bridgeAliasPrefix")}${s}`,description:`[schedule-ui] ${s}${this._t("bridgeDescPattern")}`,use_blueprint:{path:"jewon-oh/schedule-bridge-blueprint.yaml",input:{schedule_helper:a,target_device:e}}};await this.hass.callApi("POST",`config/automation/config/${r}`,n),console.log("[schedule-ui] automation create SUCCESS:",r),this._createResult={success:!0,entityId:a},this.configChanged({...this._config,entity:a})}catch(t){console.error("[schedule-ui] createRoutine FAILED:",t),this._createResult={success:!1,message:t.message||JSON.stringify(t)}}finally{this._isCreating=!1,this.requestUpdate()}}_t(e){const i=this.hass?.language?.startsWith("ko")?"ko":"en";return t[i][e]||t.en[e]}render(){if(!this.hass||!this._config)return V``;const t=!!this.hass.user?.is_admin;return V`
  ...
  `}}customElements.define("ha-custom-schedule-card-editor",ut);class pt extends lt{static{this.properties={hass:{},_config:{state:!0},_selectedEntity:{state:!0},_selectedAction:{state:!0},_isLoading:{state:!0},_creationError:{state:!0}}}setConfig(t){this._config=t,this._selectedAction=t.action_type||"turn_off"}get _lang(){return this.hass?.language&&this.hass.language.includes("ko")?"ko":"en"}_t(t){return e[this._lang]?.[t]??e.en[t]}async _onTargetEntityPicked(t){const e=t.detail.value;if(e&&e!==this._selectedEntity){this._selectedEntity=e,this._isLoading=!0,this._creationError=null;try{const t=this.hass.states[e],i=t?.attributes?.friendly_name||e;let s=null,o=null;try{const t={type:"timer/create",name:`${i}${this._t("timerSuffix")}`,icon:"mdi:timer-sand"};s=(await this.hass.callWS(t)).id,o=`timer.${s}`,console.log("[schedule-ui] timer helper create SUCCESS:",o)}catch(t){return console.warn("Timer helper auto-creation failed via config/timer/create. Error:",t),this._creationError=this._t("helperFailMsg"),void(this._isLoading=!1)}const a=this._selectedAction||"turn_off",r=`timer_bridge_${s}`,n=`${this._t("timerBridgeAliasPrefix")}${i}`;console.log("[schedule-ui] Creating timer bridge (blueprint):",r,"for target:",e);try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).find(t=>t.entity_id===`automation.${r}`);t&&await this.hass.callWS({type:"config/entity_registry/remove",entity_id:t.entity_id})}catch(t){}const c={alias:n,description:this._t("bridgeDescription"),use_blueprint:{path:"jewon-oh/timer-bridge-blueprint.yaml",input:{timer_helper:o,target_device:e,action_type:a}}};await this.hass.callApi("POST",`config/automation/config/${r}`,c),console.log("[schedule-ui] timer automation bridge (blueprint) create SUCCESS:",r),this._config={...this._config,entity:o,title:`${i}${this._t("timerSuffix")}`},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}catch(t){console.error(t),this._creationError=`${this._t("errorPrefix")}${t.message}`}finally{this._isLoading=!1}}}_onActionChange(t){this._selectedAction=t.target.value}render(){if(!this.hass||!this._config)return V``;const t=!!this.hass.user?.is_admin;return V`
      <div class="card-config">
        ${t?V`
  ...
  `}}customElements.define("ha-custom-timer-card-editor",pt);class mt extends lt{static{this.properties={hass:{},_config:{},_isCreating:{type:Boolean},_createResult:{type:Object},_displayValue:{state:!0}}}setConfig(t){this._config=t}updated(t){(t.has("_config")||t.has("hass"))&&this._refreshDisplayValue()}_t(t){const e=this.hass?.language?.startsWith("ko")?"ko":"en";return i[e]?.[t]??i.en[t]}configChanged(t){const e=new Event("config-changed",{bubbles:!0,composed:!0});e.detail={config:t},this.dispatchEvent(e)}async _onWizardDevicePicker(t){const e=t.detail.value;if(this._isCreating||!this.hass||!e)return;const i=this.hass.states[e],s=i?.attributes?.friendly_name||e.split(".")[1]||this._t("unknownDevice"),o=`${s}${this._t("routineSuffix")}`,a=`turn_on_${e.split(".")[1]||"device"}_${Date.now().toString(36)}`;this._isCreating=!0,this._createResult=null,this.requestUpdate();try{const t={alias:o,description:`[schedule-ui:turn-on] ${s}`,trigger:[],condition:[],action:[{service:"homeassistant.turn_on",target:{entity_id:e}}],mode:"single"};await this.hass.callApi("POST",`config/automation/config/${a}`,t);const i=await this._resolveEntityIdByUniqueId(a),r=i||a;this._createResult={success:!0,automationId:a,entityId:i},this.configChanged({...this._config,automation:r})}catch(t){console.error("[turn-on] wizard failed:",t),this._createResult={success:!1,message:t?.message||JSON.stringify(t)}}finally{this._isCreating=!1,this.requestUpdate()}}render(){if(!this.hass||!this._config)return V``;const t=!!this.hass.user?.is_admin;return V`
      <div class="card-config">
  ...
  `}}customElements.define("ha-custom-turn-on-card-editor",mt);const gt=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];class ft extends lt{static{this.properties={_config:{state:!0},_hass:{state:!1},_scheduleData:{state:!0},_activeDays:{state:!0},_blocks:{state:!0},_showCreateWizard:{state:!0},_isCreating:{state:!0},_createResult:{state:!0},_selectedBlockIdx:{state:!0},_resizingBlockIdx:{state:!0},_resizingEdge:{state:!0},_toast:{state:!0},_confirm:{state:!0},_isEditing:{state:!0}}}constructor(){super(),this._scheduleData=null;const t=0===(new Date).getDay()?6:(new Date).getDay()-1;this._activeDays=[t],this._blocks=[],this._showCreateWizard=!1,this._isCreating=!1,this._createResult=null,this._lang="en",this._isEditing=!1,this._selectedBlockIdx=null,this._resizingBlockIdx=null,this._resizingEdge=null,this._toast=null,this._confirm=null,this._toastTimer=null,this._saveTimer=null,this._tapStart=null}_scheduleSaveDebounced(t=400){this._saveTimer&&clearTimeout(this._saveTimer),this._saveTimer=setTimeout(()=>{this._saveTimer=null,this._updateSchedule()},t)}connectedCallback(){super.connectedCallback(),this._onDocPointerDown=t=>{if(null===this._selectedBlockIdx)return;if(null!==this._resizingBlockIdx)return;if(this._confirm||this._isEditing)return;(t.composedPath?t.composedPath():[]).some(t=>{const e=t?.classList;return!!e&&(e.contains("editor-block")||e.contains("block-handle")||e.contains("block-delete")||e.contains("block-time-pill")||e.contains("confirm-overlay")||e.contains("confirm-card")||e.contains("confirm-actions")||e.contains("danger-btn")||e.contains("ghost-btn"))})||(this._selectedBlockIdx=null)},document.addEventListener("pointerdown",this._onDocPointerDown,!0)}disconnectedCallback(){super.disconnectedCallback(),this._onDocPointerDown&&document.removeEventListener("pointerdown",this._onDocPointerDown,!0),this._saveTimer&&clearTimeout(this._saveTimer),this._toastTimer&&clearTimeout(this._toastTimer)}_showToast(t,e=3e3){this._toastTimer&&clearTimeout(this._toastTimer),this._toast={message:t},this._toastTimer=setTimeout(()=>{this._toast=null,this._toastTimer=null},e)}_openConfirm(t,e){this._confirm={message:t,onConfirm:e}}_closeConfirm(){this._confirm=null}setConfig(t){this._config=t,this._hass&&this._loadSchedule()}set hass(t){const e=this._hass;this._hass=t;let i=!e;if(t&&t.language){const e=t.language.startsWith("ko")?"ko":"en";this._lang!==e&&(this._lang=e,i=!0)}i&&this.requestUpdate(),!e&&t&&this._config&&this._loadSchedule()}_t(e){return t[this._lang][e]||t.en[e]}async _loadSchedule(){if(this._hass&&this._config.entity)try{const t=await this._hass.callWS({type:"schedule/list"}),e=this._config.entity,i=e.split(".")[1];let s=i;try{const t=await this._hass.callWS({type:"config/entity_registry/get",entity_id:e});t&&t.unique_id&&(s=t.unique_id,console.log("[schedule-ui] entity registry → unique_id:",s))}catch(t){console.warn("[schedule-ui] entity registry 조회 실패, slug 사용:",i,t)}let o=t.find(t=>t.id===s);if(o||(o=t.find(t=>t.id===i)),!o){const i=this._hass.states?.[e],s=i?.attributes?.friendly_name;s&&(o=t.find(t=>t.name===s))}console.log("[schedule-ui] loadSchedule - entity:",e,"storageId:",s,"matched:",o?o.id:"NONE"),!o&&t.length>0&&console.warn("[schedule-ui] 매칭 실패! available ids:",t.map(t=>`${t.id}(${t.name})`)),o&&(this._scheduleData=o,this._hydrateFromSchedule(o))}catch(t){console.error("[schedule-ui] Failed to load schedules",t)}}_blocksOverlap(t,e){return t.from<e.to&&e.from<t.to}_mergeIntervals(t){const e=[...t].sort((t,e)=>t.from.localeCompare(e.from)),i=[];for(const t of e){if(0===i.length){i.push({...t});continue}const e=i[i.length-1];t.from<=e.to?t.to>e.to&&(e.to=t.to):i.push({...t})}return i}_hydrateFromSchedule(t){const e=[],i=new Set;for(let s=0;s<gt.length;s++){const o=t[gt[s]]||[];o.length>0&&i.add(s);for(const t of o)e.push({from:t.from,to:t.to})}const s=this._mergeIntervals(e);if(this._blocks=s,0===i.size){const t=0===(new Date).getDay()?6:(new Date).getDay()-1;this._activeDays=[t]}else this._activeDays=[...i].sort((t,e)=>t-e);const o=new Set(e.map(t=>`${t.from}~${t.to}`)).size;o>s.length&&console.warn("[schedule-ui] hydrate: merged overlapping blocks",{rawUnique:o,merged:s.length})}async _updateSchedule(){if(this._hass&&this._scheduleData){this._isEditing=!0;try{const t=this._scheduleData.id,e={name:this._scheduleData.name};this._scheduleData.icon&&(e.icon=this._scheduleData.icon);const i=[...this._blocks].sort((t,e)=>t.from.localeCompare(e.from)),s=new Set(this._activeDays);for(let t=0;t<gt.length;t++)e[gt[t]]=s.has(t)?i:[];console.log("[schedule-ui] updateSchedule - schedule_id:",t,"activeDays:",this._activeDays,"blocks:",i),await this._hass.callWS({type:"schedule/update",schedule_id:t,...e}),await this._loadSchedule()}catch(t){console.error("[schedule-ui] updateSchedule FAILED:",t);const e=t?.code||t?.error?.code,i=String(t?.message||t||"").toLowerCase(),s="unauthorized"===e||i.includes("unauthorized")||i.includes("not allowed");this._showToast(s?this._t("unauthorized"):`${this._t("saveFailed")} ${t?.message||t}`),await this._loadSchedule()}finally{this._isEditing=!1}}}_deleteBlock(t){!this._isEditing&&this._scheduleData&&this._config?.entity&&(t<0||t>=this._blocks.length||this._openConfirm(this._t("confirmDeleteBlock"),async()=>{this._closeConfirm(),this._blocks=this._blocks.filter((e,i)=>i!==t),this._selectedBlockIdx=null,await this._updateSchedule()}))}_yToMinutes(t,e){const i=t.getBoundingClientRect(),s=Math.max(0,Math.min(1,(e-i.top)/i.height)),o=15*Math.round(1440*s/15);return Math.max(0,Math.min(1440,o))}_minutesToTimeStr(t){const e=Math.max(0,Math.min(1439,t)),i=Math.floor(e/60),s=e%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}:00`}_onColumnPointerDown(t){(t.composedPath?t.composedPath():[t.target]).some(t=>{const e=t?.classList;return!!e&&(e.contains("editor-block")||e.contains("block-handle")||e.contains("block-delete")||e.contains("block-time-pill"))})?this._tapStart=null:this._tapStart={x:t.clientX,y:t.clientY}}static{this._TAP_SLOP=8}static{this._BLOCK_MIN_DURATION=30}async _onColumnClick(t){if(this._isEditing)return;if((t.composedPath?t.composedPath():[t.target]).some(t=>{const e=t?.classList;return!!e&&(e.contains("editor-block")||e.contains("block-handle")||e.contains("block-delete")||e.contains("block-time-pill"))}))return;const e=this._tapStart;if(this._tapStart=null,!e)return;const i=ft._TAP_SLOP;if(Math.abs(t.clientX-e.x)>i||Math.abs(t.clientY-e.y)>i)return;const s=t.currentTarget,o=this._yToMinutes(s,t.clientY),a=[...this._blocks].sort((t,e)=>t.from.localeCompare(e.from)),r=a.map(t=>this._timeToMinutes(t.to)).filter(t=>t<=o).reduce((t,e)=>Math.max(t,e),0),n=a.map(t=>this._timeToMinutes(t.from)).filter(t=>t>o).reduce((t,e)=>Math.min(t,e),1440);if(o<r)return;const c=Math.max(r,o),d=Math.min(n,c+60);if(d-c<ft._BLOCK_MIN_DURATION)return void this._showToast(this._t("blockOverlap"));const l={from:this._minutesToTimeStr(c),to:this._minutesToTimeStr(d)},h=[...this._blocks,l].sort((t,e)=>t.from.localeCompare(e.from));this._blocks=h,this._selectedBlockIdx=h.findIndex(t=>t.from===l.from),await this._updateSchedule()}_selectBlock(t,e){t.stopPropagation(),this._selectedBlockIdx=this._selectedBlockIdx===e?null:e}_onSelectedDeleteClick(t,e){t.stopPropagation(),this._deleteBlock(e)}_onHandlePointerDown(t,e,i){if(t.stopPropagation(),!this._isEditing){try{t.currentTarget.setPointerCapture(t.pointerId)}catch(t){}this._resizingBlockIdx=e,this._resizingEdge=i}}_onHandlePointerMove(t,e,i){if(this._resizingBlockIdx!==e||this._resizingEdge!==i)return;const s=t.currentTarget.closest(".editor-column");if(!s)return;const o=this._blocks[e];if(!o)return;const a=this._yToMinutes(s,t.clientY),r=this._timeToMinutes(o.from),n=this._timeToMinutes(o.to),c=this._blocks.filter((t,i)=>i!==e);let d=r,l=n;if("top"===i){const t=c.map(t=>this._timeToMinutes(t.to)).filter(t=>t<=n).reduce((t,e)=>Math.max(t,e),0);d=Math.max(t,Math.min(a,n-ft._BLOCK_MIN_DURATION))}else{const t=c.map(t=>this._timeToMinutes(t.from)).filter(t=>t>=r).reduce((t,e)=>Math.min(t,e),1440);l=Math.min(t,Math.max(a,r+ft._BLOCK_MIN_DURATION))}d===r&&l===n||(this._blocks=this._blocks.map((t,i)=>i===e?{from:this._minutesToTimeStr(d),to:this._minutesToTimeStr(l)}:t))}async _onHandlePointerUp(t,e,i){if(this._resizingBlockIdx===e&&this._resizingEdge===i){try{t.currentTarget.releasePointerCapture(t.pointerId)}catch(t){}this._resizingBlockIdx=null,this._resizingEdge=null,await this._updateSchedule()}}_overlapsExisting(t,e,i=-1){return this._blocks.some((s,o)=>{if(o===i)return!1;const a=this._timeToMinutes(s.from),r=this._timeToMinutes(s.to);return t<r&&e>a})}_toggleActiveDay(t){const e=this._activeDays.includes(t)?this._activeDays.filter(e=>e!==t):[...this._activeDays,t].sort((t,e)=>t-e);0!==e.length?(this._activeDays=e,this._scheduleSaveDebounced()):this._showToast(this._t("atLeastOneDay"))}_formatTime(t){if(!t)return"";let[e,i]=t.split(":"),s=new Date;return s.setHours(parseInt(e)),s.setMinutes(parseInt(i)),new Intl.DateTimeFormat(this._lang,{hour:"numeric",minute:"numeric",hour12:!0}).format(s)}_timeToMinutes(t){if(!t)return 0;const e=t.split(":");return 60*parseInt(e[0])+parseInt(e[1])}render(){if(!this._config)return V`<ha-card><div class="error">${this._t("notConfigured")}</div></ha-card>`;if(!this._hass)return V`
      ...
      `;let t=!1,e=this._scheduleData?.name,i=this._scheduleData?.icon,s=this._blocks,o=this._activeDays;this._config.entity||(t=!0,e=this._t("scheduleManager")+this._t("previewSuffix"),i="mdi:calendar-star",s=[{from:"09:00:00",to:"18:00:00"}],o=[0,1,2,3,4]);const a=this._config.title||e||this._t("scheduleManager"),r=1440,n=new Date,c=(n.getDay()+6)%7,d=o.includes(c),l=(60*n.getHours()+n.getMinutes())/r*100,h=[...s].sort((t,e)=>t.from.localeCompare(e.from));return V`
      <ha-card class="${t?"is-dummy":""}">
        ...
        <div class="card-content">
          <div class="day-editor">
            <div class="day-editor-grid">
              ...
              <div class="editor-column"
                ...
                `)}
                ${h.map((t,e)=>{const i=this._timeToMinutes(t.from),s=this._timeToMinutes(t.to),o=i/r*100,a=(s-i)/r*100,n=this._selectedBlockIdx===e;return V`
                    <button type="button"
                            class="editor-block ${n?"selected":""}"
                            style="top: ${o}%; height: ${Math.max(a,.5)}%;"
                  ...
                  `})}
                ${d?V`<div class="now-line" style="top: ${l}%;"><span class="now-line-label">${this._minutesToTimeStr(60*n.getHours()+n.getMinutes()).slice(0,5)}</span></div>`:""}
                ${0===h.length?V`
          ...
          <div class="day-switcher" role="group" aria-label="${this._t("activeDays")}">
            ${gt.map((e,i)=>{const s=o.includes(i);return V`
                <button type="button"
          ...
          `:V`
            ...
            <div class="timer-display">
              ...
              <div class="timer-message" style="margin-top: 8px; font-size: 0.95rem; color: var(--custom-secondary); display: flex; justify-content: center;">
                ${(()=>{let t=[];r>0&&t.push(r+this._t("hoursStr")),(n>0||r>0)&&t.push(n+this._t("minutesStr")),t.push(c+this._t("secondsStr"));const e=t.join(" ");return V`<span style="background: rgba(0,0,0,0.2); padding: 4px 12px; border-radius: 12px;">${e} ${this._t("countdownMessage")}</span>`})()}
              </div>
            </div>
            <div class="progress-bar-container">
              <div class="progress-bar ${e}" style="width: ${a}%;"></div>
            </div>
          `}
  ...
  `}}customElements.define("ha-custom-timer-card",_t),window.customCards=window.customCards||[],(()=>{const t=e[s()]??e.en;window.customCards.push({type:"ha-custom-timer-card",name:t.cardName,preview:!0,description:t.cardDescription,documentationURL:"https://github.com/jewon-oh/schedule-ui"})})();const bt=["mon","tue","wed","thu","fri","sat","sun"];class vt extends lt{static{this.properties={_config:{state:!0},_hass:{state:!1},_automationId:{state:!0},_automationConfig:{state:!0},_times:{state:!0},_weekdays:{state:!0},_target:{state:!0},_isSaving:{state:!0},_toast:{state:!0},_confirm:{state:!0}}}constructor(){super(),this._lang=s(),this._automationId=null,this._automationConfig=null,this._times=[],this._weekdays=[...bt],this._target=null,this._isSaving=!1,this._toast=null,this._toastTimer=null,this._saveTimer=null,this._confirm=null}disconnectedCallback(){super.disconnectedCallback(),this._saveTimer&&clearTimeout(this._saveTimer),this._toastTimer&&clearTimeout(this._toastTimer)}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t,this._hass&&this._loadAutomation()}set hass(t){const e=this._hass;if(this._hass=t,t?.language){const e=t.language.startsWith("ko")?"ko":"en";this._lang!==e&&(this._lang=e,this.requestUpdate())}e||this.requestUpdate(),!e&&t&&this._config&&this._loadAutomation()}_t(t){return i[this._lang]?.[t]??i.en[t]}_showToast(t,e=3e3){this._toastTimer&&clearTimeout(this._toastTimer),this._toast={message:t},this._toastTimer=setTimeout(()=>{this._toast=null,this._toastTimer=null},e)}_openConfirm(t,e){this._confirm={message:t,onConfirm:e}}_closeConfirm(){this._confirm=null}async _resolveAutomationConfigId(){if(!this._hass)return null;const t=this._config?.automation;if(!t)return null;if("string"!=typeof t)return null;if(!t.startsWith("automation."))return t;try{const e=await this._hass.callWS({type:"config/entity_registry/get",entity_id:t});if(e?.unique_id)return e.unique_id}catch(t){console.warn("[turn-on] entity registry lookup failed:",t)}return t.split(".")[1]}async _loadAutomation(){if(!this._hass||!this._config?.automation)return;const t=await this._resolveAutomationConfigId();if(t)try{const e=await this._hass.callApi("GET",`config/automation/config/${t}`);this._automationId=t,this._automationConfig=e,this._hydrateFromAutomation(e),await this._maybeMigrateLegacyAlias()}catch(t){console.error("[turn-on] failed to load automation:",t),this._automationId=null,this._automationConfig=null}}async _maybeMigrateLegacyAlias(){const t=this._automationConfig;if(!t||!this._automationId||!this._hass)return;const e="string"==typeof t.alias?t.alias:"",i=[{prefix:"켜기 스케쥴: ",suffix:" 켜기 스케쥴"},{prefix:"Turn-on schedule: ",suffix:" Turn-On Schedule"}];for(const{prefix:s,suffix:o}of i){if(!e.startsWith(s))continue;const i=`${e.slice(s.length)}${o}`;if(i===e)return;const a={...t,alias:i};try{await this._hass.callApi("POST",`config/automation/config/${this._automationId}`,a),this._automationConfig=a}catch(t){console.warn("[turn-on] legacy alias migration failed:",t)}return}}_hydrateFromAutomation(t){const e=Array.isArray(t?.trigger)?t.trigger:Array.isArray(t?.triggers)?t.triggers:[],i=[];for(const t of e)if("time"===t?.platform||"time"===t?.trigger){const e=t.at;if(Array.isArray(e))for(const t of e)"string"==typeof t&&i.push(this._normalizeTime(t));else"string"==typeof e&&i.push(this._normalizeTime(e))}this._times=[...new Set(i)].sort();const s=Array.isArray(t?.condition)?t.condition:Array.isArray(t?.conditions)?t.conditions:[];let o=null;for(const t of s)if("time"===t?.condition&&Array.isArray(t.weekday)){o=t.weekday.map(t=>String(t).toLowerCase()).filter(t=>bt.includes(t));break}this._weekdays=o&&o.length>0?o:[...bt];const a=Array.isArray(t?.action)?t.action:Array.isArray(t?.actions)?t.actions:[];let r=null;for(const t of a){const e=t?.service||t?.action;if("string"==typeof e&&e.endsWith(".turn_on")&&(r=t?.target?.entity_id||t?.data?.entity_id||t?.entity_id||null,Array.isArray(r)&&(r=r[0]),r))break}this._target=r}_normalizeTime(t){if(!t||"string"!=typeof t)return"00:00:00";const e=t.split(":");return`${String(Math.max(0,Math.min(23,parseInt(e[0]||"0",10)||0))).padStart(2,"0")}:${String(Math.max(0,Math.min(59,parseInt(e[1]||"0",10)||0))).padStart(2,"0")}:00`}_scheduleSaveDebounced(t=400){this._saveTimer&&clearTimeout(this._saveTimer),this._saveTimer=setTimeout(()=>{this._saveTimer=null,this._saveAutomation()},t)}async _saveAutomation(){if(this._hass&&this._automationId&&this._automationConfig)if(this._target){this._isSaving=!0;try{const t=[...new Set(this._times)].sort().map(t=>({platform:"time",at:t})),e=7===this._weekdays.length?[]:[{condition:"time",weekday:[...this._weekdays].sort((t,e)=>bt.indexOf(t)-bt.indexOf(e))}],i=[{service:"homeassistant.turn_on",target:{entity_id:this._target}}],s={...this._automationConfig,trigger:t,condition:e,action:i};delete s.triggers,delete s.conditions,delete s.actions,await this._hass.callApi("POST",`config/automation/config/${this._automationId}`,s),this._automationConfig=s}catch(t){console.error("[turn-on] save failed:",t);const e=t?.code||t?.error?.code,i=String(t?.message||t||"").toLowerCase(),s="unauthorized"===e||i.includes("unauthorized")||i.includes("not allowed");this._showToast(s?this._t("unauthorized"):`${this._t("saveFailed")} ${t?.message||t}`),await this._loadAutomation()}finally{this._isSaving=!1}}else this._showToast(this._t("automationNotFound"))}_addTime(){let t="08:00:00";if(this._times.length>0){const e=[...this._times].sort().slice(-1)[0],[i,s]=e.split(":").map(Number),o=(60*i+s+60)%1440;t=`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}:00`}if(this._times.includes(t))for(let e=0;e<1440;e+=15){const i=`${String(Math.floor(e/60)).padStart(2,"0")}:${String(e%60).padStart(2,"0")}:00`;if(!this._times.includes(i)){t=i;break}}this._times=[...this._times,t].sort(),this._scheduleSaveDebounced()}_removeTime(t){this._openConfirm(this._t("confirmDeleteTime"),()=>{this._closeConfirm(),this._times=this._times.filter((e,i)=>i!==t),this._scheduleSaveDebounced()})}_onTimeInput(t,e){const i=t.target.value;if(!i)return;const s=this._normalizeTime(i);if(this._times[e]===s)return;if(this._times.includes(s))return this._showToast(this._t("duplicateTime")),void(this._times=[...this._times]);const o=[...this._times];o[e]=s,this._times=o.sort(),this._scheduleSaveDebounced()}_toggleWeekday(t){const e=this._weekdays.includes(t)?this._weekdays.filter(e=>e!==t):[...this._weekdays,t];0!==e.length?(this._weekdays=e.sort((t,e)=>bt.indexOf(t)-bt.indexOf(e)),this._scheduleSaveDebounced()):this._showToast(this._t("atLeastOneDay"))}_targetFriendlyName(){if(!this._target||!this._hass)return this._target||"";const t=this._hass.states?.[this._target];return t?.attributes?.friendly_name||this._target}render(){if(!this._config)return V`<ha-card><div class="error">${this._t("notConfigured")}</div></ha-card>`;if(!this._hass)return V`
      ...
      `;const t=!this._config.automation,e=this._automationConfig?.alias,i=this._target?`${this._targetFriendlyName()}${this._t("routineSuffix")}`:null,s=this._config.title||e||i||this._t("title"),o=t?["08:00:00","18:30:00"]:this._times,a=t?["mon","tue","wed","thu","fri"]:this._weekdays,r=t?"switch.example":this._target;return V`
      <ha-card class="${t?"is-dummy":""}">
        ${t?V`<div class="dummy-badge">${this._t("previewSuffix").trim()}</div>`:""}
        ...
        <div class="card-content">
          ${t||this._automationConfig?V`
            ...
            <div class="day-switcher" role="group" aria-label="${this._t("days").join("/")}">
              ${bt.map((e,i)=>{const s=a.includes(e);return V`
                  <button type="button"
                          class="day-pill ${s?"selected":""}"
                          aria-pressed="${s}"
                          ?disabled=${t}
                          @click=${()=>this._toggleWeekday(e)}>
                    ${this._t("daysShort")[i]}
                  </button>
                `})}
            </div>
  ...
  `}static getConfigElement(){return document.createElement("ha-custom-turn-on-card-editor")}static getStubConfig(){return{}}getCardSize(){return this._config?.automation?4:5}getGridOptions(){return{columns:12,min_rows:3}}}customElements.define("ha-custom-turn-on-card",vt),window.customCards=window.customCards||[],window.customCards.push({type:"ha-custom-turn-on-card",name:i[s()].cardName,preview:!0,description:i[s()].cardDescription,documentationURL:"https://github.com/jewon-oh/schedule-ui"}),console.log("%c[schedule-ui] v1.4.7 loaded","color: #03a9f4; font-weight: bold; font-size: 14px;");
